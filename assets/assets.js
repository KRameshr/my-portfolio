...
export const serviceData = [
  {
    ...
    description:
      "Building responsive and dynamic websites using the latest web technologies like React, Next.js, Node.js, and MongoDB.",
...
export const infoList = [
  {
    ...
    title: "Languages",
    description:
      "HTML,CSS,JavaScript,Tailwind CSS,React Js,Next Js,JavaScript,Node.js,Express.js,MongoDB",
  },
  {
    icon: assets.code_icon,
    iconDark: assets.code_icon_dark,
  ...
  },
  {
    ...
    title: "Education",
    description: "B.Tech in Electrical and Electronics Engineering",
  },
  {
